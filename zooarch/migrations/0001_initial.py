    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('collection_method', models.CharField(choices=[('Hand Selected', 'Hand Selected'), ('Floatation', 'Floatation'), ('Preflotation', 'Preflotation'), ('Sieve', 'Sieve')], default='', max_length=25)),
                ...
                ('comments', models.TextField(blank=True, default='', max_length=500, null=True)),
